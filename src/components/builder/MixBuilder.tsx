      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 max-w-md mx-4 text-center shadow-2xl border border-white/20">
            ...
            <a
              href="https://wa.me/5493513239624?text=Hola!%20Confirmo%20mi%20pedido%20personalizado%20de%20Mix%20de%20⚡%20Frutos%20Secos%20y%20quiero%20coordinar%20la%20entrega%20y%20pago%20en%20efectivo.%20Gracias!"
              target="_blank"
